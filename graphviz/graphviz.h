...
void    DotLeftEdgeCtor     (void* num1, void* num2, const char* style = "none", const char* color = "dodgerblue");   
void    DotRightEdgeCtor     (void* num1, void* num2, const char* style = "none", const char* color = "dodgerblue");   
