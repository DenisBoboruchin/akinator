...
all: main.o okenator.o graphviz.o
	g++ okenator/okenator.cpp graphviz/graphviz.cpp main.cpp -o main

main.o: main.cpp
	g++ $(CFLAGS) main.cpp

okenator.o: okenator/okenator.cpp
	g++ $(CFLAGS) okenator/okenator.cpp
